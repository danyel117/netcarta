...
3. **Challenge intro (15s)** — "Today's race: Lando Norris → Border Collie." Show join URL + QR on screen. Invite judges to join from phones.
...
5. **It's shareable after the event.** "I got Lando Norris → Border Collie in 6 clicks" is a tweet.
